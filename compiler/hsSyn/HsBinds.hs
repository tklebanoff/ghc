...
type instance XTLKS             (GhcPass p) = NoExt
...
type instance XTopKindSig  (GhcPass p) = NoExt
type instance XXTopKindSig (GhcPass p) = Void

tlksName :: TopKindSig (GhcPass p) -> IdP (GhcPass p)
tlksName (TopKindSig _ lname _) = unLoc lname
tlksName (XTopKindSig x) = absurd x
